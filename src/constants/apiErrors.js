...
export const API_ERROR_LABELS = {
  es: {
    ...
    PARENT_INACTIVE_CANNOT_ACTIVATE: "No se puede activar esta cuenta porque la cuenta padre está inactiva. Activa primero el padre.",
    POSTING_ACCOUNT_CODE_TOO_SHORT: "Las cuentas de movimiento requieren al menos 6 dígitos.",
    ROOT_ACCOUNT_CODE_INVALID_LENGTH: "Las cuentas raíz deben tener exactamente 1 dígito.",
    CHILD_CODE_MUST_START_WITH_PARENT: "El código de la subcuenta debe comenzar con el código de la cuenta padre.",
    INVALID_CODE_STRUCTURE: "La estructura del código no es válida para el nivel jerárquico seleccionado.",
    PARENT_CLASS_MISMATCH: "La cuenta padre pertenece a otra clase contable — las subcuentas deben compartir la misma clase.",
    HAS_ACCOUNTING_MOVEMENTS_CANNOT_DEACTIVATE: "No se puede desactivar este tercero porque tiene movimientos contables. Contacta a tu administrador si necesitas archivarlo.",
    DOCUMENT_NUMBER_TOO_LONG: "El número de documento es demasiado largo para calcular el dígito de verificación (máximo 15 dígitos).",
  ...
  en: {
    ...
    PARENT_INACTIVE_CANNOT_ACTIVATE: "Can't activate this account because its parent account is inactive. Activate the parent first.",
    POSTING_ACCOUNT_CODE_TOO_SHORT: "Posting accounts require at least 6 digits.",
    ROOT_ACCOUNT_CODE_INVALID_LENGTH: "Root accounts must have exactly 1 digit.",
    CHILD_CODE_MUST_START_WITH_PARENT: "The sub-account code must start with the parent account's code.",
    INVALID_CODE_STRUCTURE: "The code structure isn't valid for the selected hierarchy level.",
    PARENT_CLASS_MISMATCH: "The parent account belongs to a different account class — sub-accounts must share the same class.",
    HAS_ACCOUNTING_MOVEMENTS_CANNOT_DEACTIVATE: "Can't deactivate this third party because it has accounting movements. Contact your administrator if you need to archive it.",
    DOCUMENT_NUMBER_TOO_LONG: "The document number is too long to calculate the verification digit (max 15 digits).",
